 ...
 * Return: The index marking the end of the initial word pointed by the string
 */
int word_len(char *str)
{
	int index = 0, len = 0;
 ...
 * Return: if str = NULL, str = "", or function fails then = NULL,
 * Otherwise it points to an array of strings (words).
 */
char **strtow(char *str)
{
	char **strings;
